...
# Non-atomic: 0104 creates its indexes CONCURRENTLY, which an atomic rewind cannot replay.
...
class BackfillReportStalenessClocksMigrationTest(NonAtomicTestMigrations):
    ...
    migrate_from = "0104_signalreport_staleness_indexes"
    migrate_to = "0105_backfill_report_staleness_clocks"

...
MCP_SERVER_CATALOG: list[CatalogEntry] = [
    ...
    CatalogEntry(
        ...
        description="Search Granola meeting notes, transcripts, and meeting insights.",
        auth_type="oauth",
        category="dev",
        icon_domain="granola.ai",
    ),
    CatalogEntry(
        name="Hex",
    ...
    CatalogEntry(
        ...
        description="Manage LaunchDarkly AI Configs for prompts, models, and runtime AI settings.",
        auth_type="oauth",
        category="dev",
    ...
    CatalogEntry(
        ...
        description="Explore LaunchDarkly observability errors, sessions, logs, and traces.",
        auth_type="oauth",
        category="dev",
        icon_domain="launchdarkly.com",
    ),
    CatalogEntry(
        ...
        description="Manage Linear issues, projects, teams, and workflows.",
        auth_type="oauth",
        category="productivity",
    ...
    CatalogEntry(
        ...
        description="Manage PagerDuty incidents, services, schedules, and on-call rotations in the EU region.",
        auth_type="oauth",
        category="productivity",
    ...
    CatalogEntry(
        ...
        description="Manage PagerDuty incidents, services, schedules, and on-call rotations in the US region.",
        auth_type="oauth",
        category="productivity",
        icon_domain="pagerduty.com",
    ),
